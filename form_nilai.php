...
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <h4>Form Nilai Siswa</h6>
                    <hr>
                    <form method="GET" action="form_nilai.php">
                        <div class="form-group row mt-3 mx-3">
                            <label for="Nama Lengkap" class="col-2 col-form-label text-right">Nama Lengkap</label>
                            <div class="col-6">
                        ...
                        <div class="form-group row mt-3 mx-3">
                            <label class="col-2 col-form-label text-right" for="Mata Kuliah">Mata Kuliah</label>
                            <div class="col-6">
                        ...
                        <div class="form-group row mt-3 mx-3">
                            <label for="Nilai UTS" class="col-2 col-form-label text-right">Nilai UTS</label>
                            <div class="col-6">
                                <input id="nilai_uts" name="nilai_uts" placeholder="Nilai UTS" type="text"
                                    class="form-control" required="required">
                            </div>
                        </div>
                        <div class="form-group row mt-3 mx-3">
                            <label for="Nilai UAS" class="col-2 col-form-label text-right">Nilai UAS</label>
                            <div class="col-6">
                                <input id="nilai_uas" name="nilai_uas" placeholder="Nilai UAS" type="text"
                                    class="form-control" required="required">
                            </div>
                        </div>
                        <div class="form-group row mt-3 mx-3">
                            <label for="Nilai Tugas" class="col-2 col-form-label text-right">Nilai
